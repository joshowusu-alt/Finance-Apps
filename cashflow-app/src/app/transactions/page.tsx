      ...
      <div className="vn-card p-6">
        ...
        <form onSubmit={handleAddTransaction} className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <label className="text-xs font-semibold text-slate-600">Amount (GBP)</label>
              <input
                type="number"
                placeholder="0.00"
                step="0.01"
            ...
            {newTransaction.type === "income" ? (
              <div>
                <label className="text-xs font-semibold text-slate-600">Income source</label>
                <select
            ...
            {newTransaction.type === "transfer" ? (
              <div>
                <label className="text-xs font-semibold text-slate-600">Savings target</label>
                <select
            ...
            outflowRuleOptions.length > 0 ? (
              <div>
                <label className="text-xs font-semibold text-slate-600">Outflow rule (optional)</label>
                <select
          ...
          {Object.values(variance)
            ...
            .map((v) => {
              ...
              return (
                ...
                >
                  <div className="text-sm text-slate-600 capitalize">{v.category}</div>
        ...
        <div className="vn-card p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-white/80 p-4 shadow-sm">
              <div className="text-xs font-semibold text-slate-500">Budgeted transfer</div>
              <div className="mt-2 text-2xl font-semibold text-slate-900">
                {gbp(savingsReconciliation.budgeted)}
              </div>
            </div>
            <div className="rounded-2xl bg-white/80 p-4 shadow-sm">
              <div className="text-xs font-semibold text-slate-500">Actual transfer</div>
              <div className="mt-2 text-2xl font-semibold text-slate-900">
                            ...
                            <div className="flex-1 min-w-[220px]">
                              ...
                              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                                ...
                                {txn.notes && (
                                  <>
                                    <span className="text-slate-300">|</span>
                                    <span className="text-slate-500">{txn.notes}</span>
                                  </>
                                )}
                              </div>
                            </div>
