...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-24 right-4 z-50 w-70 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-800/95 p-4 shadow-xl">
